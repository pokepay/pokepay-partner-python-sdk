...
class PokepayTest(unittest.TestCase):
    ...
    def test_update_coupon_7(self):
        response = client.send(pp.UpdateCoupon(
                                  ...
                                  starts_at="2020-07-14T04:13:02.000000Z",
                                  discount_upper_limit=6654,
                                  description="9rogVZwJO2xNcltqUbvpNyoJI0vqJ8n0oUjQYsKaRMsrJUacY2rYQO4gmGHCfbUV5BkcqYiSNlDYC6MEWefziiHI3EykNpjwCPjAkzyY2kmUe2JJ53U3N6F0e26pbO3HttlG",
                                  name="4eyiatMI7VF3dtugJSz1Q3"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_8(self):
        response = client.send(pp.UpdateCoupon(
                                  "03096659-bf35-4842-98e7-2395dc20d12e",
                                  discount_amount=1966,
                                  is_disabled=False,
                                  display_ends_at="2021-01-14T14:45:43.000000Z",
                                  display_starts_at="2020-07-23T20:56:28.000000Z",
                                  ends_at="2021-01-23T04:39:42.000000Z",
                                  starts_at="2024-08-05T04:29:49.000000Z",
                                  discount_upper_limit=9334,
                                  description="ovXNsgFsW05W19aXuGVVRQlUVJv9CZ2ZsBhmJBENJ2Jp2YLnPueitIaB8AWaFb8JKCZbl1FLUJSG0fudQ9bvTSzMBL1Qigy",
                                  name="h82R8yfv5oZ1A8LucSTZwJytxSEpRfXYxFxM"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_10(self):
        response = client.send(pp.UpdateCoupon(
                                  ...
                                  is_hidden=True,
                                  is_disabled=False,
                                  display_ends_at="2022-05-16T06:17:59.000000Z",
                                  display_starts_at="2023-12-06T10:07:44.000000Z",
                                  ends_at="2020-05-04T05:39:22.000000Z",
                                  starts_at="2021-07-23T03:24:47.000000Z",
    ...
    def test_update_coupon_11(self):
        response = client.send(pp.UpdateCoupon(
                                  ...
                                  is_hidden=False,
                                  is_disabled=True,
                                  display_ends_at="2024-06-11T00:25:37.000000Z",
                                  display_starts_at="2024-03-11T06:49:54.000000Z",
                                  ends_at="2022-07-19T12:19:24.000000Z",
                                  starts_at="2020-11-01T00:46:38.000000Z",
                                  discount_upper_limit=1989,
                                  description="HiVXoG09ihrRj4aejWMyEn4Q3X3BDxBJJ5t6h3IPcBKQDcagEkitF8i",
                                  name="ACEva8PG"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_12(self):
        response = client.send(pp.UpdateCoupon(
                                  ...
                                  is_hidden=False,
                                  is_disabled=True,
                                  display_ends_at="2022-06-10T09:45:46.000000Z",
                                  display_starts_at="2023-10-23T17:45:14.000000Z",
                                  ends_at="2020-08-22T03:01:23.000000Z",
                                  starts_at="2021-03-29T04:33:15.000000Z",
    ...
    def test_update_coupon_13(self):
        response = client.send(pp.UpdateCoupon(
                                  ...
                                  is_hidden=True,
                                  is_disabled=True,
                                  display_ends_at="2024-12-22T16:38:51.000000Z",
                                  display_starts_at="2024-11-18T21:34:02.000000Z",
                                  ends_at="2023-12-09T04:22:12.000000Z",
                                  starts_at="2021-04-19T11:13:19.000000Z",
                                  discount_upper_limit=9699,
                                  description="w5PoatcF0TU5W5omYIqjFLKdIYieVX7m2aCCypluKCuWAlkVHsDkHFJvihW5VcQOv2mc2ISnCuuu6HEZICTUsFd55cysKpzPw06buTFvYo4vEubGw6jVHah2jNyPqoWcQPdnYsCcbQIY2KFXsspdkpVkTBJa3OTrsXs88kJNoIZazm0lWPTZ7efHVp4Du6bqVzq0H9hNDIpWOGRlL4QDCIWrLzYwdZH6RYisLngmui2yyfAvCUPPfC6gP",
                                  name="yCFjnlF5wS89FXtStGksuJSc3uI6YbNMb4YSuPWKo7xO0kav9UABs7zcSSckrHrP7zrKa6Deu24AbEENpv2m"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_14(self):
        response = client.send(pp.UpdateCoupon(
                                  ...
                                  is_hidden=False,
                                  is_disabled=True,
                                  display_ends_at="2020-12-02T20:27:02.000000Z",
                                  display_starts_at="2022-07-05T01:08:31.000000Z",
                                  ends_at="2024-05-18T20:00:25.000000Z",
                                  starts_at="2021-12-07T16:58:56.000000Z",
                                  discount_upper_limit=7833,
                                  description="sGLqJFlRMGfDCisIe5qHDsMdG7wbTKEpXzySqqc4sXPad6xuwUqi64YRTYtsOeEN9XbwlgwBy5OkIYkbdAf4PBqh2Y5zV0C85Vn4l2htJKp8EeWwIbRZU73CECtq6YH4jkVjZI7iaSuegvmESb5ZkkQma0HXRKUqv4lzkwZFtSWx4aRECgS2Rzs2ylIq5ZtrGXVCQUhbREfojZVoiIjURbvF5cuoyvA3tbiunsY6SNRraYwc8QD",
                                  name="AEfV4F8XUQw7FOCvHUkEBp2LxsthHBe9EWUoT5QLe9Yg2CBY3rucfBues6uHoyn0kY9tu08AkjC0WPKbQvYow9FaOH3zD7SQmRuyNCM"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_15(self):
        response = client.send(pp.UpdateCoupon(
                                  ...
                                  available_shop_ids=["2c6d6816-ef70-4ac7-8ce7-6c9441d0a455", "a493fe41-194b-4e1e-be81-5d049e68d9cb", "ee8d49b4-4a41-41af-9d84-182d3c741b7e", "639f8559-7789-4fd8-a253-a58f8d75aaf4", "4f998d26-a19a-439d-85d4-7f9a6157bac8", "b5c1ba0f-8cfd-4919-878f-7159ba45f347", "02b6f5a0-30c3-44d4-b6c6-6a02eec8225c", "958a4553-e92f-48f6-b2f9-dcb215dce663", "8a9c338d-48e9-47c7-baf0-419136268428"],
                                  is_shop_specified=True,
                                  min_amount=3091,
                                  usage_limit=5029,
                                  code="dg5yn158",
                                  ...
                                  is_hidden=True,
                                  is_disabled=True,
                                  display_ends_at="2024-03-03T22:11:35.000000Z",
                                  display_starts_at="2022-07-24T17:25:31.000000Z",
                                  ends_at="2024-04-29T04:52:18.000000Z",
                                  starts_at="2024-08-20T00:44:58.000000Z",
                                  discount_upper_limit=7838,
                                  description="aT1YQUtPEMBFK5RCvbOFISTKPBIbnB4IlVfzKQeAZtwqv4AGYkQ5YWzuO0mrMzlLTVYxU13omHKmdh2ng7xlmB0D7qlClsr3peE1RPsdDZEoaT5osfv5Au45ikmQzjXEIrL5tEVsPccciqGzpCuGxgjotbAnDFm6nBFTBcp5MgKi6djde9q9Gx06zspIhW3gmaN6JcrvmX5G7cBGoNqTURH3hLLIVR7YcRrTeQ",
                                  name="sLdvK2PUyIdpshyxjFJxJ7Fcj7Ywb40WRFS5iP8DHnWS95dKYCDWjMDqXUFGoRA4XvfiL62Wv2vl8qJa"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_16(self):
        response = client.send(pp.UpdateCoupon(
                                  "03096659-bf35-4842-98e7-2395dc20d12e",
                                  discount_amount=2474,
                                  storage_id="ccf3d266-8f8a-45e3-b73a-e842b243041e",
                                  available_shop_ids=["ae8f6c70-bc00-474c-ac8c-dc54d6497bd2", "236e2f4e-e02e-44b1-a19d-40307e9f96ec", "5e3fd7e1-cd72-443b-a1b5-13231877f663", "6c69665f-78fc-438d-b6bb-458a4abeaae0", "9d7150ed-81d7-4aeb-9e5d-65361236d8c8"],
                                  is_shop_specified=True,
                                  min_amount=4147,
                                  usage_limit=8827,
                                  code="Edv56",
                                  ...
                                  is_hidden=True,
                                  is_disabled=False,
                                  display_ends_at="2024-12-19T04:24:20.000000Z",
                                  display_starts_at="2021-09-13T21:57:01.000000Z",
                                  ends_at="2024-11-01T06:55:18.000000Z",
                                  starts_at="2021-03-08T02:05:20.000000Z",
                                  discount_upper_limit=3168,
                                  description="uIJJqB3hC6IgJljp1y8KOJgfu4WFT3sPLKGiMRgfz5jiMdvRW63Z9043h9SU3fTD5o4Kn6TQ",
                                  name="PsH9YtmnNiOZyV9AO3DnB1YRES4xlc6449ibwy8gDnWqdIP3eIh1Py"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_17(self):
        response = client.send(pp.UpdateCoupon(
                                  "03096659-bf35-4842-98e7-2395dc20d12e",
                                  discount_amount=8079,
                                  discount_percentage=483.0
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_18(self):
        response = client.send(pp.UpdateCoupon(
                                  "03096659-bf35-4842-98e7-2395dc20d12e",
                                  discount_amount=7410,
                                  discount_percentage=842.0,
    ...
    def test_update_coupon_19(self):
        response = client.send(pp.UpdateCoupon(
                                  ...
                                  description="CPEoMCgQwCdLCVxkfS7LC09h1a33P4feIw8rNkq1IJcIVXzbXoLITUciADNRcm8cr7h7uvpVmJgh2hspBOtxaFVpQwu69vaYb020lVhpK1ujAV4SIGQkIPmfa5YJsZSIV5H0hKFZRjFJsBJwxE5ymHkkfvwj75uGxXyxLiKvyAHQ0Cmh0GR2iNpQgbrTS2HEffP70DHCU",
                                  name="hTMu269OO6DIw88je3Px2M6UQ20lAXsAZIDxFXqpctZUoXMEwvfZIhfCcdWRRWKBpAMRk3KT9aHDvn680BNVo61whu52VEWHzeXnCqnnjKe2Zokc"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_20(self):
        response = client.send(pp.UpdateCoupon(
                                  "03096659-bf35-4842-98e7-2395dc20d12e",
                                  discount_amount=668,
                                  discount_percentage=9937.0,
                                  discount_upper_limit=7191,
                                  description="t9okwN5c4Mkgq5YYKEEntoCEiLAHJ2sW9FitjutUJJsIkCXGENUTkzcX2ykkKJlN107OaiUpqdHMS0BnQNQ8yntRPdiO7nDWAmmXsETvex6EwUtMqxtCSMEZW",
                                  name="LR3IYMZqZQp71KYV2dqAhSRH0jBaTj6CKr7da3Hc5MrDSrY"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_21(self):
        response = client.send(pp.UpdateCoupon(
                                  ...
                                  discount_percentage=8238.0,
                                  starts_at="2024-10-28T21:45:36.000000Z",
                                  discount_upper_limit=5969,
                                  description="TFD8MK4LhwIRladKEnUCUBMTsHjSLXQWZdqZHXOS9NchMxuvMOV5pE0ThIcNVnpd1n04FvafoOT5XflXygJfyBJl1nws6Ne3S7kdpHli9FCf9v",
                                  name="j51iwXi5vVka"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_22(self):
        response = client.send(pp.UpdateCoupon(
                                  "03096659-bf35-4842-98e7-2395dc20d12e",
                                  discount_amount=6761,
                                  discount_percentage=2615.0,
                                  ends_at="2024-10-29T03:58:30.000000Z",
                                  starts_at="2023-02-11T03:45:17.000000Z",
                                  discount_upper_limit=7337,
                                  description="dPllBkchJ2ELHNBkuEPtWGn6U1tknXv7iBjpuz8kXfTQVtq7nYSMGg6A5q48d0VvhbqvZRxaI0AVDH5phIrM988xOpACBuWehCLI5Ithzp",
                                  name="o1"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_23(self):
        response = client.send(pp.UpdateCoupon(
                                  ...
                                  discount_percentage=777.0,
                                  display_starts_at="2021-03-14T00:20:43.000000Z",
                                  ends_at="2022-02-08T08:10:38.000000Z",
                                  starts_at="2024-02-06T06:13:41.000000Z",
                                  discount_upper_limit=8162,
                                  description="w0fi8Tfl4MiezYuuDN5NO2HkiJUlQ4dKgR3uo3pyHQKCLEzAV2HW0T6wtgFowhjkpuax7inTCKJlAlkDX0z9k4WtlP60t1pGDCB7WpLioRLUylhwp3jBXylmnzTDYQPTQEhEDpiIl88uXhFr9tzNaCFLhrW7Qg63LOoyDRk2frbKYDtHXRSpeSviFk4W1q",
                                  name="OLMcNwe8KEeqmGGreSt4nt1ybC0Ywm3a7y1jkUDzYlQVbUnnRBBQRDsGnvgO2bodBPeKpRFsQIEwGMkEBFs4OKbpkXgOJ3P1nM9riBWugVW8sRaEhx8a"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_24(self):
        response = client.send(pp.UpdateCoupon(
                                  "03096659-bf35-4842-98e7-2395dc20d12e",
                                  discount_amount=7485,
                                  discount_percentage=3931.0,
                                  display_ends_at="2023-06-29T03:11:39.000000Z",
                                  display_starts_at="2024-09-07T07:30:41.000000Z",
                                  ends_at="2020-09-02T05:39:37.000000Z",
                                  starts_at="2023-02-11T06:59:31.000000Z",
                                  discount_upper_limit=4042,
                                  description="HuUfzU3cxqLSG8S4aP0CNMNfb6VowWUVfzovzP7VL5ebcijLtVhmlM6kBu7D",
                                  name="CNg4aU7BlWsNE"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_25(self):
        response = client.send(pp.UpdateCoupon(
                                  "03096659-bf35-4842-98e7-2395dc20d12e",
                                  discount_amount=9027,
                                  discount_percentage=1938.0,
                                  is_disabled=True,
                                  display_ends_at="2021-09-26T16:12:07.000000Z",
                                  display_starts_at="2021-03-07T00:35:52.000000Z",
                                  ends_at="2020-06-22T12:09:16.000000Z",
                                  starts_at="2022-02-05T10:46:50.000000Z",
                                  discount_upper_limit=2523,
                                  description="tcjGtIPadSKiVX8t6IuP7AfSh1iSdnomWlXA8y2vwAsTNYaeLyV7CWdrmk7DRyx2nAdRh4U2Gnj6HilrfsKlPIExrXeCFOu5KxrV4xhz7DzBywKIciMlN0S7L0N0uBHj0xIlmI7crwjgiJmBq8x2BMoiejWmPY8qwKCFWRUhTWJtrSHM5KvGCx3jvLeQXqJ7fOtRApW564YK0LvLN69VHlYJhXH6cUQL7XLfiXA0zUZ8WIiKSeWU9z6",
                                  name="AbD3wpFlmsWusC8RGaBKUJdHLf9kwaxRbmzAo5vzrqC43kvR5VzS4JSx7Qk5qYm8EJV1By6vGk0FuWZ3ptkSyNBcc9paWacdvlF8sKq6M8TMc"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_26(self):
        response = client.send(pp.UpdateCoupon(
                                  "03096659-bf35-4842-98e7-2395dc20d12e",
                                  discount_amount=7400,
                                  discount_percentage=5680.0,
                                  is_hidden=False,
                                  is_disabled=True,
                                  display_ends_at="2024-12-31T06:02:28.000000Z",
                                  display_starts_at="2021-05-23T02:25:03.000000Z",
                                  ends_at="2024-07-25T11:42:49.000000Z",
                                  starts_at="2020-05-17T14:22:23.000000Z",
                                  discount_upper_limit=1613,
                                  description="sXgvG8EYKbsPpBkO0z5h9VDX3NEhsO0rjGagOIQ6x9sSfu0zX8zdCniT7rbp4RdF8jzLLX07kGwmR",
                                  name="ZR89QJDye"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_27(self):
        response = client.send(pp.UpdateCoupon(
                                  ...
                                  is_hidden=True,
                                  is_disabled=True,
                                  display_ends_at="2024-04-22T23:39:24.000000Z",
                                  display_starts_at="2022-06-02T18:52:51.000000Z",
                                  ends_at="2023-03-06T05:15:30.000000Z",
                                  starts_at="2024-03-23T03:30:48.000000Z",
                                  discount_upper_limit=8217,
                                  description="7qh3KP4T37Wi9g9nZZhOiq9TM1kLnMOaPoayQ1SL4LwXctk2uyuazqzFpngLk90ZBFe71DIECbUavopCer6amUqWii2uDVrmTki6pqO0f8",
                                  name="cnptMkBRjmpnnbeCg4xumOoxK0oT4F795unttA065Yr03Qzj1SYSblk7QSMdkkKPr"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_28(self):
        response = client.send(pp.UpdateCoupon(
                                  "03096659-bf35-4842-98e7-2395dc20d12e",
                                  discount_amount=9243,
                                  discount_percentage=6516.0,
                                  code="zf",
                                  is_public=False,
                                  is_hidden=False,
                                  is_disabled=False,
                                  display_ends_at="2022-10-26T01:52:19.000000Z",
                                  display_starts_at="2024-10-05T22:06:03.000000Z",
                                  ends_at="2023-06-29T08:12:17.000000Z",
                                  starts_at="2020-07-18T08:24:12.000000Z",
    ...
    def test_update_coupon_29(self):
        response = client.send(pp.UpdateCoupon(
                                  ...
                                  is_hidden=True,
                                  is_disabled=False,
                                  display_ends_at="2022-12-02T11:36:16.000000Z",
                                  display_starts_at="2023-09-16T20:54:02.000000Z",
                                  ends_at="2020-06-28T15:13:28.000000Z",
                                  starts_at="2020-11-12T11:59:52.000000Z",
                                  discount_upper_limit=3907,
                                  description="yXSjsNQfhm4JdiSR8LU0sAxVpKo9Pr8tnCR4b3VVcnR7ySaTJSLXaRbjFaOCY9HY0faJMcRsZ3tfn14pqdpY2gOVzxC2AMFc",
                                  name="qtkzhdfPKiy9SERDVnpaYhOvVB8b8Y5rPTIoQafvlfkuyBchbjOVFfaAmwoPiUeFs2qGGZk77FXigkPx1NC7bcdhHDyq2B"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_30(self):
        response = client.send(pp.UpdateCoupon(
                                  ...
                                  is_hidden=True,
                                  is_disabled=True,
                                  display_ends_at="2020-09-22T15:41:31.000000Z",
                                  display_starts_at="2023-06-17T16:41:58.000000Z",
                                  ends_at="2025-02-01T09:32:11.000000Z",
                                  starts_at="2021-04-02T16:07:55.000000Z",
                                  discount_upper_limit=802,
                                  description="UAnFDq2j42XbKSjWX0mczdG92I3EQWa6MviKhzgN1WE1E9QE8I1WOtKGTOoDsggK2zVvIrNmjPyMt7JZTknlcSLOAfgHki7iEUUEZsYB8I8w6YX9AjYRSoiU1BYQYTGkBMdZ9gxwOlUDOeBSRiyqeame",
                                  name="aY0bgN8gTUkelv3hkGmk4iWQZAVafOlabiOcEnloh2DXft8ZR3ZIT5H8aSOl3MDXnG9yHqEAThwDuq"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_31(self):
        response = client.send(pp.UpdateCoupon(
                                  ...
                                  is_hidden=True,
                                  is_disabled=True,
                                  display_ends_at="2024-05-14T10:48:41.000000Z",
                                  display_starts_at="2023-04-14T21:51:04.000000Z",
                                  ends_at="2023-05-02T08:08:24.000000Z",
                                  starts_at="2021-09-23T11:18:49.000000Z",
                                  discount_upper_limit=4282,
                                  description="xEPrWNcD1BCJ2Q7A3yxMyBqUSnmfmyMf158jbodxUJxcIS6QwIFvAWCZsB1EYOxuNXsb8K4XyQ60l6nZCLpElUd6iH1X66E0nqBBGm",
                                  name="KnZ6uDIn3iuFQrrgeXzyNXNrNkeWa9hWsLSo"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_32(self):
        response = client.send(pp.UpdateCoupon(
                                  "03096659-bf35-4842-98e7-2395dc20d12e",
                                  discount_amount=9232,
                                  discount_percentage=9142.0,
                                  available_shop_ids=["4dfa5987-2d11-43e8-80ec-59d260dde72e", "349827f2-b04e-4100-8698-88e400470792", "b9e7f86d-3ea8-43cd-9ce1-d113854a9274"],
                                  is_shop_specified=False,
                                  min_amount=7811,
                                  usage_limit=6144,
                                  code="y",
                                  ...
                                  is_hidden=True,
                                  is_disabled=True,
                                  display_ends_at="2023-05-08T20:40:55.000000Z",
                                  display_starts_at="2021-02-11T10:34:25.000000Z",
                                  ends_at="2023-02-06T11:27:46.000000Z",
                                  starts_at="2022-12-18T22:33:35.000000Z",
                                  discount_upper_limit=4307,
                                  description="sd06fYHa9pHdUJ2NkpD9XRln1g4q1AmzenaBAIYsPX5BEVEkSwN7Jl7UfMqNeIWxDQ5mYkDBp76iPlz0WyF7I2Snzg812cd0lMhCHFE2kwBpeHriIaXxYmUfeD23BKTCZPKhRk3w9r2MS5qnBpeG29hBWbNKIGuoyWD3BHeU5bcdtREmG3PoPoUnVURoRDP0303M0EUzCR0X",
                                  name="C7"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_33(self):
        response = client.send(pp.UpdateCoupon(
                                  "03096659-bf35-4842-98e7-2395dc20d12e",
                                  discount_amount=2445,
                                  discount_percentage=5058.0,
                                  storage_id="d0179229-5281-4f49-91db-d399229bf74e",
                                  available_shop_ids=["368df719-9377-4745-88d3-8ff17b06f429", "5a22f437-7668-43e0-90f9-1b2995852cb7", "2e0f4561-c3b3-401b-86b5-d8cd05fc6042", "ca461543-f932-4c43-b7d6-9316f3c05966", "122bfd60-e541-452b-a4be-93ce9740a775", "55209b8a-e633-4170-a68a-36b63895162c", "4811e2b2-f74b-440d-84a1-1c57db683b0a", "3ea4c918-647e-4d4f-b80c-eb541e6ff891", "b6132f99-c144-4672-8b4c-f33b1c8a0098"],
                                  is_shop_specified=True,
                                  min_amount=2715,
                                  usage_limit=2665,
                                  code="D",
                                  ...
                                  is_hidden=False,
                                  is_disabled=True,
                                  display_ends_at="2024-11-16T03:59:58.000000Z",
                                  display_starts_at="2024-01-29T10:47:54.000000Z",
                                  ends_at="2021-07-04T01:31:47.000000Z",
                                  starts_at="2024-04-07T04:38:12.000000Z",
                                  discount_upper_limit=7368,
                                  description="pSJ7ezaoKVM6PG4nVxadlDXYh8F3jX5Rw62VEObOlMsiJRl1b2ESaJKCDCVaIjvXY9buv1PGDaqpxNAcB7XJ2PMH0HA7mMCxlziaJ1nphI9ySRxw6pdyrj7YEb5BIbPwZWptKeWMAfjTzhjO10bQw",
                                  name="yTU6ZUhrOp80a47LYIcD579HHiydYwYbStQsIHShYuqMOfry8huKLaun9q8fRCMt2pzYekawpUouvYHKlj0GUL0Fcnz7fEngR6pF3m54VmwYrgFgT3RyUt1Kexb2ZI"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_35(self):
        response = client.send(pp.UpdateCoupon(
                                  "03096659-bf35-4842-98e7-2395dc20d12e",
                                  discount_percentage=7886.0,
                                  name="8OgDDQYpUk9QvTpwbva3X3fUufQzzx2hzebS68SpNEGkfmS3U"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_36(self):
        response = client.send(pp.UpdateCoupon(
                                  "03096659-bf35-4842-98e7-2395dc20d12e",
                                  discount_percentage=7563.0,
                                  description="yy5Zn41VzLKUg3om1YNfeeKoLdFE8Hmt9",
    ...
    def test_update_coupon_37(self):
        response = client.send(pp.UpdateCoupon(
                                  "03096659-bf35-4842-98e7-2395dc20d12e",
                                  discount_percentage=7882.0,
                                  discount_upper_limit=2267,
                                  description="iR7mxn7kYGzShazSiZH",
                                  name="6DDfNqfsVRi3zxzsVzVJLxpF9uCjOUSNMH9fWh27PiOpr3HMMXsb4Lh4b0Gk"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_38(self):
        response = client.send(pp.UpdateCoupon(
                                  ...
                                  starts_at="2022-06-08T18:08:06.000000Z",
    ...
    def test_update_coupon_39(self):
        response = client.send(pp.UpdateCoupon(
                                  ...
                                  ends_at="2021-10-13T16:28:11.000000Z",
                                  starts_at="2022-09-07T07:28:27.000000Z",
                                  discount_upper_limit=1531,
                                  description="FT0f7did2pSfVDNNjekhaUaqNZOry7pQcwkQvvHfTZTUiaSBniTvgiFcfFWfXoobW27D2zSsjxSJQCC2TKE3m70u0i2E7",
                                  name="e3WCog3HknLhb4mGHjaX24jJAlJFQ82MhyQQoipgFN"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_40(self):
        response = client.send(pp.UpdateCoupon(
                                  "03096659-bf35-4842-98e7-2395dc20d12e",
                                  discount_percentage=1302.0,
                                  display_starts_at="2021-05-11T12:42:59.000000Z",
                                  ends_at="2024-03-03T13:05:36.000000Z",
                                  starts_at="2020-08-31T10:20:26.000000Z",
                                  discount_upper_limit=5858,
                                  description="dQD1VXjUggH7qMtHhSfZdXUyjb1NxKa8yAWf3eI4rn2GKxT",
                                  name="8MfsHveV88627AlMJYf8MI0c9iCp3raZonaiDazAfoVN5ZcNoMxEFE11voG9m7"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_41(self):
        response = client.send(pp.UpdateCoupon(
                                  "03096659-bf35-4842-98e7-2395dc20d12e",
                                  discount_percentage=3687.0,
                                  display_ends_at="2022-10-28T11:37:53.000000Z",
                                  display_starts_at="2021-05-26T22:46:47.000000Z",
                                  ends_at="2023-05-15T23:51:37.000000Z",
                                  starts_at="2020-12-15T17:24:57.000000Z",
                                  discount_upper_limit=6556,
                                  description="csFhnnSlOPQSKVW980GqQVfPuvUPiEFV6mDyiAjmPC8FhIFplNkUQpOFZAAuAkdYYYV8q02r77ePIgPu4dPH7ImSF7bIQ97lNoNEq",
                                  name="qi11P4GN23Eb6NlDd7BTwpYu4Valw5xiIJ7Q1Cipp2CPMRifbrHbdPk0z0U5np6zSSSsJChBCfGVrTTzFEA3cEkuniAENmb"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_42(self):
        response = client.send(pp.UpdateCoupon(
                                  "03096659-bf35-4842-98e7-2395dc20d12e",
                                  discount_percentage=4446.0,
                                  is_disabled=True,
                                  display_ends_at="2022-04-26T18:57:13.000000Z",
                                  display_starts_at="2023-03-14T11:04:42.000000Z",
                                  ends_at="2024-04-16T09:08:59.000000Z",
                                  starts_at="2022-03-10T03:31:47.000000Z",
                                  discount_upper_limit=8052,
                                  description="M74yoK3yNaovdjb7urlPondGWEfVzKMwihh3UCJATPnnGfbS",
                                  name="jt8y1LpRX9w3aEMSDM7H6DKpMVCMs6AqPF1N4VGIihJYcZH1yqyLKdrb7VdvBferrd"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_43(self):
        response = client.send(pp.UpdateCoupon(
                                  "03096659-bf35-4842-98e7-2395dc20d12e",
                                  discount_percentage=3152.0,
                                  is_hidden=False,
                                  is_disabled=True,
                                  display_ends_at="2024-05-06T18:43:42.000000Z",
                                  display_starts_at="2021-02-08T15:10:31.000000Z",
                                  ends_at="2020-11-04T10:45:40.000000Z",
                                  starts_at="2024-09-15T10:04:02.000000Z",
                                  discount_upper_limit=5508,
                                  description="Bp21GVpuNthlN8cTNxtClPPAh3ydu7juMaO7kqGjaASQkqyw2Q45pim16jWY8Li2yJuAILC9WmiQzTAP0hsvYk94ECXfwyrT6FNWSeiPJDkaNGUUFy37fVBCxguWkgEaSRxikajDhky1e9MUM8ZY9eEBDTjFI18oRpgCoDiEOfsuO3LMtzPm5pmHiztzTLcjSeNyveotr1SbLY9f9RM3h2SXQaAm6",
                                  name="MSYVoPQWfV62UhTGJS1L9KLOsA2Q2Z23Mwd98ipOldTUQCXPcZtLDZ6t1d7NhS3tIbiaQ9UqJHQZFkEmVia7WMZwoONY9mYcjUD3BWfN3h"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_44(self):
        response = client.send(pp.UpdateCoupon(
                                  "03096659-bf35-4842-98e7-2395dc20d12e",
                                  discount_percentage=5839.0,
                                  is_public=True,
                                  is_hidden=True,
                                  is_disabled=True,
                                  display_ends_at="2024-11-19T22:23:30.000000Z",
                                  display_starts_at="2024-10-30T19:55:07.000000Z",
                                  ends_at="2022-12-12T12:31:34.000000Z",
                                  starts_at="2022-01-02T02:25:02.000000Z",
                                  discount_upper_limit=1978,
    ...
    def test_update_coupon_46(self):
        response = client.send(pp.UpdateCoupon(
                                  ...
                                  is_hidden=False,
                                  is_disabled=False,
                                  display_ends_at="2021-01-19T04:03:13.000000Z",
                                  display_starts_at="2024-05-24T01:14:41.000000Z",
                                  ends_at="2022-09-09T16:44:52.000000Z",
                                  starts_at="2020-05-09T13:27:29.000000Z",
                                  discount_upper_limit=2235,
                                  description="OryINKyRmJ3gWCDcmsuvkMrJePtGFhv4aIw1aGtGR3fEQezBo8XnXONHGXDMcl8tuhVdB5KkP8PHvZEmmcBKkGsr9sdEDTBkey7pr4d2jpaf36YY6mrG9Y2ztoKUUUx5B1bSO8xEgnoe60dnWTCVmm3x115QsBZT6dCGgqZsePkl6iY0bdXM6Nza2rTctUJQmh0gNd3qkWY4lVW5zCUF3",
                                  name="WzIdrHm6OsiyHBxsWBtx4G7cLViMByCBNzcDCX5bbsPzVUGeD2BWp2XUNEsAtEjlivj0NhalsavWYZduuXynvh05rJdAnnKPkjJzRbGyuQYyb8948tP6VkRaNaN"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_47(self):
        response = client.send(pp.UpdateCoupon(
                                  ...
                                  is_hidden=False,
                                  is_disabled=True,
                                  display_ends_at="2020-06-27T15:56:34.000000Z",
                                  display_starts_at="2024-06-07T07:28:33.000000Z",
                                  ends_at="2022-02-04T10:22:23.000000Z",
                                  starts_at="2023-09-01T21:35:02.000000Z",
    ...
    def test_update_coupon_49(self):
        response = client.send(pp.UpdateCoupon(
                                  ...
                                  available_shop_ids=["4ecaadef-ff48-4378-92ba-79ab18cd7035", "8b68414e-0033-42c4-a04f-1607bf7e6dcf", "8bd547b7-cac1-4980-a4af-ea888987f18d", "d1861bf8-b9c1-454e-8445-4f32a7e38190"],
                                  is_shop_specified=False,
                                  min_amount=6369,
                                  usage_limit=675,
                                  code="2",
                                  ...
                                  is_hidden=True,
                                  is_disabled=True,
                                  display_ends_at="2022-03-12T21:49:39.000000Z",
                                  display_starts_at="2021-11-28T00:34:35.000000Z",
                                  ends_at="2023-01-27T12:31:33.000000Z",
                                  starts_at="2021-06-24T07:19:20.000000Z",
                                  discount_upper_limit=1037,
                                  description="Qkk2AG5TTqX05IlCZ5tUdSwXVRIVCnlZj6NtOwX2FI8Wr1369uaTF42abkgSmtEHAWzKVmwmqN4ax1Q1Fha0o1JxRbdO7sJMkOiIt9zNKCX0VzisXLLiEpULitiIsW57odiOHhS8DsZfAQRFK6oTTeP8tTTuInowX",
                                  name="TMHi2vDKbmu86aUF4jypKaAY4yQaiw0JpUpNfjrUKaUCU4cuncf"
        ))
        self.assertNotEqual(response.status_code, 400)
    ...
    def test_update_coupon_50(self):
        response = client.send(pp.UpdateCoupon(
                                  "03096659-bf35-4842-98e7-2395dc20d12e",
                                  discount_percentage=1317.0,
                                  storage_id="f404814f-a967-4a02-a8da-60ddae4cc567",
                                  available_shop_ids=["64af2a30-ebf6-4b10-aefa-dab99d2363f6", "e6e831df-92e4-4dc8-815d-c000b610b458", "22620baf-7e33-4b7a-89b2-3b03f9b971b1", "f65645cd-e696-42e0-bb1a-d93955e0c100"],
                                  is_shop_specified=True,
                                  min_amount=4493,
                                  usage_limit=4990,
                                  code="KUqkr",
                                  ...
                                  is_hidden=True,
                                  is_disabled=True,
                                  display_ends_at="2024-02-08T03:22:05.000000Z",
                                  display_starts_at="2022-02-25T05:44:03.000000Z",
                                  ends_at="2024-12-27T14:15:25.000000Z",
                                  starts_at="2020-07-05T19:35:16.000000Z",
                                  discount_upper_limit=1691,
                                  description="eLmERqX5bwDROtzb2hizqeaCyQXA4kt1s5IzgftNOCeiOWbpouk4VaYSYsKX6oU3L4",
                                  name="6cfTNsJ74FdhPrGorQztiuURWZ5r1OnryKkdpmMzmoITg"
        ))
        self.assertNotEqual(response.status_code, 400)
