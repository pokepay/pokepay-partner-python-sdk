...
response = client.send(pp.GetAccountTransferSummary(
                          ...
                          start="2021-06-15T15:04:08.000000Z",                  # 集計期間の開始時刻
                          to="2023-02-16T09:40:32.000000Z",                     # 集計期間の終了時刻
...
response = client.send(pp.ListTransfers(
                          start="2023-05-13T05:54:28.000000Z",
                          to="2020-08-04T14:27:17.000000Z",
                          page=7968,
                          per_page=8638,
                          shop_id="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
                          shop_name="Qlphw1DkmThPoIdPA7X1r8JTPyIk7mw82VAIRkHcNMg",
                          customer_id="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
                          customer_name="qN77FQwuiGtQW4pnFSkfz0ZAYuHKErS89ga8rAwXpAiqwTxt1HL4wWzmkMDA4SVfWD13Zj3L9DQPYajb0tVdWEdtL2ujHb",
                          transaction_id="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
                          private_money_id="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
                          is_modified=True,
                          transaction_types=["payment"],
                          transfer_types=["exchange"],                          # 取引明細の種類でフィルターします。
...
response = client.send(pp.ListTransfersV2(
                          ...
                          shop_name="i2Q1VWdznJ",                               # 店舗名
                          customer_id="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",   # エンドユーザーID
                          customer_name="ovLhT0BrHH",                           # エンドユーザー名
                          transaction_id="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", # 取引ID
                          private_money_id="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", # マネーID
                          is_modified=False,                                    # キャンセルフラグ
                          transaction_types=["exchange", "expire", "payment", "transfer", "cashback", "topup"], # 取引種別 (複数指定可)、チャージ=topup、支払い=payment
                          ...
                          transfer_types=["cashback", "payment"],               # 取引明細種別 (複数指定可)
                          description="店頭QRコードによる支払い",                          # 取引詳細説明文
                          start="2023-01-16T15:20:47.000000Z",                  # 開始日時
                          to="2025-01-03T11:34:34.000000Z"                      # 終了日時
))
```
