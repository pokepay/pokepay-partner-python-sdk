...
response = client.send(pp.ListShops(
                          ...
                          name="oxスーパー三田店",                                     # 店舗名
                          postal_code="9018603",                                # 店舗の郵便番号
                          address="東京都港区芝...",                                  # 店舗の住所
                          tel="05-782238",                                      # 店舗の電話番号
                          email="UtXGZ9lfp9@TwgY.com",                          # 店舗のメールアドレス
                          external_id="P",                                      # 店舗の外部ID
...
response = client.send(pp.CreateShop(
                          ...
                          shop_postal_code="936-8781",                          # 店舗の郵便番号
                          shop_address="東京都港区芝...",                             # 店舗の住所
                          shop_tel="0918812625",                                # 店舗の電話番号
                          shop_email="oAdT5yPsPR@TmUY.com",                     # 店舗のメールアドレス
                          shop_external_id="dZdYDDGZDuZn0XgqQIqTu14tSh13qLZ",   # 店舗の外部ID
...
response = client.send(pp.CreateShopV2(
                          "oxスーパー三田店",                                          # name: 店舗名
                          postal_code="471-4225",                               # 店舗の郵便番号
                          address="東京都港区芝...",                                  # 店舗の住所
                          tel="0225712418",                                     # 店舗の電話番号
                          email="5yXIKvcyey@tZUe.com",                          # 店舗のメールアドレス
                          external_id="Ozn4",                                   # 店舗の外部ID
                          organization_code="ox-supermarket",                   # 組織コード
...
response = client.send(pp.UpdateShop(
                          "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",               # shop_id: 店舗ユーザーID
                          name="oxスーパー三田店",                                     # 店舗名
                          postal_code="758-7231",                               # 店舗の郵便番号
                          address="東京都港区芝...",                                  # 店舗の住所
                          tel="0687-94-711",                                    # 店舗の電話番号
                          email="6jQwMdVQzE@T3CT.com",                          # 店舗のメールアドレス
                          external_id="R3naadmHoO937wRncWgLEMvwuXt",            # 店舗の外部ID
                          private_money_ids=["xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"], # 店舗で有効にするマネーIDの配列
                          can_topup_private_money_ids=["xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"], # 店舗でチャージ可能にするマネーIDの配列
