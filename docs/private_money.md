...
response = client.send(pp.GetPrivateMoneyOrganizationSummaries(
                          ...
                          start="2024-03-28T17:31:11.000000Z",                  # 開始日時(toと同時に指定する必要有)
                          to="2022-08-02T11:53:54.000000Z",                     # 終了日時(fromと同時に指定する必要有)
                          page=1,                                               # ページ番号
...
response = client.send(pp.GetPrivateMoneySummary(
                          "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",               # private_money_id: マネーID
                          start="2021-10-30T20:43:30.000000Z",                  # 開始日時
                          to="2021-05-20T06:48:33.000000Z"                      # 終了日時
))
```
