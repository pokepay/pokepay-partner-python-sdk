...
response = client.send(pp.ListBills(
                          page=3694,                                            # ページ番号
                          per_page=6986,                                        # 1ページの表示数
                          bill_id="9",                                          # 支払いQRコードのID
                          private_money_id="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", # マネーID
                          organization_code="S9",                               # 組織コード
                          description="test bill",                              # 取引説明文
                          created_from="2020-05-18T07:50:26.000000Z",           # 作成日時(起点)
                          created_to="2024-12-26T07:10:04.000000Z",             # 作成日時(終点)
                          shop_name="bill test shop1",                          # 店舗名
                          shop_id="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",       # 店舗ID
                          lower_limit_amount=5124,                              # 金額の範囲によるフィルタ(下限)
                          upper_limit_amount=7847,                              # 金額の範囲によるフィルタ(上限)
