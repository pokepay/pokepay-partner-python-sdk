...
response = client.send(pp.CreateCampaign(
                          "lxmPSv0sqeMHVeJGZnQaE4lp3S7TMyfZKpPybiZ1Lwce18e7Eq5OqWuTabdRaaHOyfGqVUncXzhjskeGyZxmbEy050Zlv3tzVr8aTPDqMKbxS0Vs3OlIrdnx7rU9F", # name: キャンペーン名
                          "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",               # private_money_id: マネーID
                          "2020-04-02T06:14:00.000000Z",                        # starts_at: キャンペーン開始日時
                          "2024-09-07T02:24:52.000000Z",                        # ends_at: キャンペーン終了日時
                          6329,                                                 # priority: キャンペーンの適用優先度
